let storyOne = `Look, if ${name} had one ${nouns}, one opportunity to ${verb} everything ${name} ever wanted - one moment, would ${name} ${verb2} or just let it ${adv} slip? Yo his palms are ${noun2}, knees weak, ${adj} arms are heavy there's vomit on his ${adj2} sweater already - mom's spaghetti. ${name}'s nervous but on the surface ${name}'s calm and ready to ${adv2} drop bombs but ${name} keeps on forgetting.`
